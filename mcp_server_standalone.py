#!/usr/bin/env python3
"""
Standalone MCP Server for Paperscraper
...
This standalone version avoids package initialization issues by setting environment 
variables before any imports.
"""
...
# Add paperscraper to path and import
